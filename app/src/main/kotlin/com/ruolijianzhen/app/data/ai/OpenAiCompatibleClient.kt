...
/**
 * OpenAI兼容客户端
 * 支持OpenAI、通义千问、DeepSeek、Ollama等兼容OpenAI API格式的服务
 */
@Singleton
class OpenAiCompatibleClient @Inject constructor() {
    
    companion object {
        private const val DEFAULT_URL = "https://api.openai.com/v1"
    ...
    private fun parseResponse(responseBody: String): AiResult? {
        return try {
            ...
            val message = choices.getJSONObject(0)
                .optJSONObject("message") ?: return null
